...
export class TCanvas {
  ...
  private assets: Assets = {
    image1: { path: 'images/eye (1).png' },
    image2: { path: 'images/eye (2).png' },
    image3: { path: 'images/eye (3).png' },
    image4: { path: 'images/eye (4).png' },
    image5: { path: 'images/eye (5).png' },
    image6: { path: 'images/eye (6).png' },
    image7: { path: 'images/eye (7).png' },
    image8: { path: 'images/eye (8).png' },
    image9: { path: 'images/eye (9).png' },
    image10: { path: 'images/eye (10).png' },
    image11: { path: 'images/eye (11).png' },
    image12: { path: 'images/eye (12).png' },
    image13: { path: 'images/eye (13).png' },
    image14: { path: 'images/eye (14).png' },
